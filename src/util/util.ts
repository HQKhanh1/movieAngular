export enum UTIL {
  ...
  ICON_ERROR = 'error',
  ALERT_MESAGE_SUCCESS_AVATAR = 'Change avatar successfully!',
  ALERT_MESAGE_SUCCESS_DETAIL_ACCOUNT = 'Change account info successfully!',
  ALERT_MESAGE_SUCCESS_ADD_GENRE = 'Create genre successfully!',
  DEFAUT_MOVIE_POSTER_NAME = 'defaule_movie.png',
  DEFAULT_MOVIE_POSTER_URL = './assets/image/default_movie.png',
  DEFAUT_ACCOUNT_IMAGE_NAME_MALE = 'male.png',
  DEFAULT_ACCOUNT_IMAGE_URL_MALE = './assets/image/male.png',
